...
export default function UserRegister() {
  ...
  return (
    <>
      <Head>
        <title>User Registration | Shelter Connect</title>
      </Head>
      <div className="max-w-md mx-auto py-12 px-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-2">Join us to report and track those in need.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input required type="text" className="w-full pl-10 pr-4 py-3 rounded-xl border dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:ring-2 outline-none" placeholder="John Doe" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} />
              </div>
            </div>
          ...
          <p className="text-center mt-6 text-sm text-gray-500 dark:text-gray-400">
            Already have an account? <Link href="/user/login" className="text-rose-600 dark:text-rose-400 font-medium hover:underline">Log in</Link>
          </p>
        </motion.div>
      </div>
    </>
